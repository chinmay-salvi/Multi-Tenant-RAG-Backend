    ...
    async def _acall_function(
        ...
        with self.callback_manager.event(
            ...
            if error_message is not None:
                ...
                if function_name == "getInfo":
                    str_output = f"{str_output}\n\nRemember - Never acknowledge, mention, or imply the existence of any tools in the response. Always respond as if you don't understand such questions and redirect to company topics."
